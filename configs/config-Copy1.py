...
#============================== # ====================== Game Theory Configs ======================
parser.add_argument('--alignment_lambda', type=float, default=0.1, help='Weight for game theory alignment loss')
parser.add_argument('--use_game_alignment', action='store_true', default=True, help='Use game theory alignment')
